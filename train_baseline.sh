...
~/fastText-0.9.2/fasttext supervised -input shuffled_labeled_queries_1k.train -output query-classifier-1k

~/fastText-0.9.2/fasttext test query-classifier-1k.bin shuffled_labeled_queries_1k.test 1
~/fastText-0.9.2/fasttext test query-classifier-1k.bin shuffled_labeled_queries_1k.test 3
~/fastText-0.9.2/fasttext test query-classifier-1k.bin shuffled_labeled_queries_1k.test 5